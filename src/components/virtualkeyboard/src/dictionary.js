...
export const keys = [
  ...
  },
  {
    value: "取消",
    w: "154px",
    color: "linear-gradient(180deg, #ffc069 0%, #ff9e0d 100%)",
  },
  {
    value: "确定",
    w: "154px",
 ...
 * @param {number} pos 
 */
export function setCaretPosition(elem, pos) {
  // IE
...
/* 点击效果指令 */
export function handleClick(el, binding) {
  function handle(e) {
      const customOpts = Object.assign({}, binding.value)
      const opts = Object.assign({
              ele: el, // 波纹作用元素
              type: 'hit', // hit 点击位置扩散 center中心点扩展
              color: 'rgba(0, 0, 0, 0.25)', // 波纹颜色
              opacity:0.25
          },
          customOpts
      )
      ...
      if (target) {
          ...
          if (!ripple) {
              ...
              ripple.style.opacity = opts.opacity
